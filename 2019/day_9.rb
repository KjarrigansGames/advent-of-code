class Intcode
  ...
  def next
    ...
    when /3/
      print 'Inp: '
      set_value(pointer + 1, STDIN.gets.chomp.to_i, mode: opcode[-1, 1] || 0)
      @pointer += 2
    when /4/
